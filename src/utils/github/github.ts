 ...
 */
export async function getGithubToken(): Promise<GithubTokenResult> {
 ...
 */
export async function fetchGithubAPI(url: string, token: string): Promise<Response> {
 ...
 */
export async function fetchPaginatedGithubAPI<T = unknown>(baseUrl: string, token: string, page = 1, allItems: T[] = []): Promise<T[]> {
